<template>
    <div>
        ...
        <template v-if="photoShow">
            ...
            <Button type="ghost" @click="createdPhotoFolder" v-if="isshowEdit">新建相册</Button>
            <!-- 循环生成照片文件夹 -->
        ...
        <template v-else>
            ...
            <Row :gutter="16" class="album mt20">
                ...
                <i-col span="6" v-for="(item,index) in photoList" :key="index">
                    <figure class="wrap mb10 border drop-out pointer">
                        <Dropdown trigger="click" placement="right-start" style="position: absolute; z-index: 999;" class="drop-in"  v-if="isshowEdit">
                            <Icon type="arrow-down-b" style="padding:2px 5px;"></Icon>
                            <Dropdown-menu slot="list">
                                <Dropdown-item>
        ...
        <!-- 编辑文件夹 -->
        <Modal v-model="editPhotoFolderShow" title="编辑相册" width="600" :mask-closable="false">
        ...
        <!-- 编辑照片 -->
        <Modal v-model="editPhotoShow" title="编辑照片" width="600" :mask-closable="false">
