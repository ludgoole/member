...
<script>
    ...
    export default {
        ...
        methods: {
            show: function () {
                api.post('/member/corpInfo/findCorpInfoTitle/1', this.datas).then(response => {
            ...
            nextPage(page) {
                api.post('/member/corpInfo/findCorpInfoTitle/' + page, this.datas).then(response => {
                    if (response.code === 200) {
                        this.enterprise = response.data.list;
                        this.total = response.data.total;
                    }
            ...
            search(obj) {
                ...
                this.datas = data;
                api.post('/member/corpInfo/findCorpInfoTitle/1', data).then(response => {
                    if (response.code === 200) {
                        this.enterprise = response.data.list;
                        this.total = response.data.total;
                    }
