            ...
            <div class="layouts">
                ...
                <div class="tc mt30 mb80">
                   <router-link :to="{path:'./commodity', query:{uid:$route.query.uid}}">
                        <Button type="ghost" class="per-btn-theme">查看更多 <Icon type="ios-arrow-right"></Icon></Button>
                    </router-link>
                </div>
            </div>
        </div> -->
            ...
            <div class="layouts">
                ...
                <div class="tc mt50">
                    <router-link :to="{path:'./dynamic', query:{uid:$route.query.uid}}">
                        <Button type="ghost" class="per-btn-theme" size="large">查看更多 <Icon type="ios-arrow-right"></Icon></Button>
                    </router-link>
                </div>
            </div>
        </div>
