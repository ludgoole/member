            ...
            <template v-for="item in lawsData.lawsDataBefor">
                ...
                <Col span="6">
                    <Card :padding="30" class="tc">
                        ...
                        <Button v-if="item.columnType === '图书'"  type="ghost" @click="bookClick(item.informationDetailId,item.id)">了解详情</Button>
                        <Button v-else type="ghost" @click="lawsGo(item.informationDetailId)">了解详情</Button>
                    </Card>
                </Col>
            </template>
        </Row>
