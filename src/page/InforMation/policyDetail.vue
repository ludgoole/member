        ...
        <div class="container">
            ...
            <Row>
                ...
                <Row type="flex" align="middle" class="swiper-ivu">
                    <!-- swiper1 -->
                    <swiper :options="swiperOptionTop" class="gallery-top" @slideChangeTransitionEnd="clickMe"
                            ref="swiperTop">
                    ...
                    <template v-if="AplayerShow && songs.length>0">
                        ...
                        <p style="line-height: 24px;padding-bottom: 10px;color: #666;font-size: 14px;text-indent: 2em;word-wrap:break-word">
                            {{v.describe}}</p>
                ...
                <Row type="flex" align="middle">
                    ...
                    <h3 class="xgzx ell">
                        ...
                        <template v-if="upPage !== -1">
                            <a :href="['/InforMation/bookBlurb?id='+informationId+'&informationDetailId='+upPage+'&book_type=policy']" v-show="column_type ==='图书'">
                                <span style="color: #4FAC77;">{{upPageTitle}}</span>
                            </a>
                    ...
                    <h3 class="xgzx ell">下一篇：
                        <template v-if="nextPage !== -1">
                            <a :href="['/InforMation/bookBlurb?id='+informationNextId+'&informationDetailId='+nextPage+'&book_type=policy']" v-show="column_next_type==='图书'">
                                <span style="color: #4FAC77;">{{nextPageTitle}}</span>
                            </a>
                    ...
                    <Button type="text" style="padding-right: 0px" @click="jubaoAdd">
                        <Icon type="alert-circled" size="16"></Icon>
                        举报
                    </Button>
                    </Col>
                </Row>
