            ...
            <div class="new-last">
                ...
                <!-- <ul>
                    <li v-for="item in list">
                        <router-link :to="{ path: '/InforMation/knowledgeDetail', query: { 'id': item.informationDetailId }}" v-show="item.columnType!='图书'"><p class="h4 ell mb15">{{ item.title }}</p></router-link>
                        <router-link :to="{ path: '/InforMation/bookBlurb', query: { 'id': item.id,informationDetailId:item.informationDetailId,book_type:'knowledge' }}" v-show="item.columnType=='图书'"><p class="h4 ell mb15">{{ item.title }}</p></router-link>
                    ...
                    <a v-if="list.length > 0">
                        <Button type="ghost" class="new-more mt20" @click="knowledge()">更多</Button>
                    </a>
                </ul>
            </div>
        </Col>
