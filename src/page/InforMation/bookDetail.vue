            ...
            <Row class="pt20">
                ...
                <Row type="flex" align="middle">
                    ...
                    <h3 class="xgzx">
                        ...
                        <a :href="['/InforMation/bookBlurb?id='+informationId+'&informationDetailId='+upPage+'&book_type=information']" v-show="column_type==='图书'"><span style="color: #4FAC77;">{{upPageTitle}}</span></a>
                        <a :href="['/InforMation/findInforMationDetail?id='+upPage+'&book_type=information']" v-show="column_type!=='图书'"><span style="color: #4FAC77;">{{upPageTitle}}</span></a>
                        </template>
                        <template v-if="upPage !== -1 && book_type ==='knowledge'">
                            <a :href="['/InforMation/bookBlurb?id='+informationId+'&informationDetailId='+upPage+'&book_type=knowledge']" v-show="column_type ==='图书'"><span style="color: #4FAC77;">{{upPageTitle}}</span></a>
                            <a :href="['/InforMation/knowledgeDetail?id='+upPage+'&book_type=knowledge']" v-show="column_type!=='图书'"><span style="color: #4FAC77;">{{upPageTitle}}</span></a>
                        </template>
                        <template v-if="upPage !== -1 && book_type ==='policy'">
                            <a :href="['/InforMation/bookBlurb?id='+informationId+'&informationDetailId='+upPage+'&book_type=policy']" v-show="column_type ==='图书'"><span style="color: #4FAC77;">{{upPageTitle}}</span></a>
                            <a :href="['/InforMation/policyDetail?id='+upPage+'&book_type=policy']" v-show="column_type!=='图书'"><span style="color: #4FAC77;">{{upPageTitle}}</span></a>
                        </template>
                        <template v-if="upPage === -1">
                            <span style="color: #4FAC77;">没有上一篇</span>
                        </template>
                    </h3>
                    <h3 class="xgzx">下一篇：
						<template v-if="nextPage !== -1 && book_type ==='information'">
                        <a :href="['/InforMation/bookBlurb?id='+informationNextId+'&informationDetailId='+nextPage+'&book_type=information']" v-show="column_next_type==='图书'"><span style="color: #4FAC77;">{{nextPageTitle}}</span></a>
                        <a :href="['/InforMation/findInforMationDetail?id='+nextPage+'&book_type=information']" v-show="column_next_type!=='图书'"><span style="color: #4FAC77;">{{nextPageTitle}}</span></a>
                        </template>
                        <template v-if="nextPage !== -1 && book_type ==='knowledge'">
                            <a :href="['/InforMation/bookBlurb?id='+informationNextId+'&informationDetailId='+nextPage+'&book_type=knowledge']" v-show="column_next_type==='图书'"><span style="color: #4FAC77;">{{nextPageTitle}}</span></a>
                            <a :href="['/InforMation/knowledgeDetail?id='+nextPage+'&book_type=knowledge']" v-show="column_next_type!=='图书'"><span style="color: #4FAC77;">{{nextPageTitle}}</span></a>
                        </template>
                        <template v-if="nextPage !== -1 && book_type ==='policy'">
                         <a :href="['/InforMation/bookBlurb?id='+informationNextId+'&informationDetailId='+nextPage+'&book_type=policy']" v-show="column_next_type==='图书'"><span style="color: #4FAC77;">{{nextPageTitle}}</span></a>
                        <a :href="['/InforMation/policyDetail?id='+nextPage+'&book_type=policy']" v-show="column_next_type!=='图书'"><span style="color: #4FAC77;">{{nextPageTitle}}</span></a>
                        </template>
                        <template v-if="nextPage === -1">
                            <span style="color: #4FAC77;">没有下一篇</span>
                        </template>
                    </h3>
                    </Col>
                    <collect-modal v-model="collectShow"  :itemId="itemId" :itemType="itemType" :link="link" :collectTitle="collectTitle"></collect-modal>
                    <Col span="4">
                    <div class="zanBtn">
                ...
                <div class="mb30">
                    <div class="comment-detail">
                        <div>
                            <h5 ><Icon type="chatbox-working"> </Icon> &nbsp;  网友评价 </h5>
          ...
          // 点击目录取数据
            ...
            checkUser() {
                if(!this.loginuserinfo) {
					...
					this.$refs.top.modal2 = true
					this.$refs.top.value = '登录'
            ...
            collect() {
                if (this.loginuserinfo != null) {
                    // 是否已经收藏了
                    api.post('/member/report/isExist', {
                        link: this.link,
                        account: this.loginuserinfo.loginAccount
                    }).then(resp => {
                        if (200 === resp.code) {
