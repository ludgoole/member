		...
		<div class="container">
			...
			<Row>
				...
				<Row type="flex" align="middle">
					...
					<collect-modal v-model="collectShow" v-on:collectForm="collectForm" :itemId="itemId" :itemType="itemType" :link="link" :collectTitle="collectTitle"></collect-modal>
					<Col span="4">
					<div class="zanBtn">
					...
					.then(response => {
                       ...
                       if(response.data.videoImgs.length){
                        ...
                        if (this.editerAccount) {
                            api.get('/member/login/findbyname/' + this.editerAccount)
                                .then(resp => {
                                    if (200 === resp.code) {
