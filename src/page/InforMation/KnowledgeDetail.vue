            ...
            <Row>
                <Col span="18">
                    ...
                    <div class="zx-time clear">
                        ...
                        <span>{{source}}</span>
                        <a :href="editerUrl"><span>发布人：{{editer}}</span></a>
                    ...
                    <Row type="flex" align="middle" class="swiper-ivu">
                        <!-- swiper1 -->
                        <swiper :options="swiperOptionTop" class="gallery-top" @slideChangeTransitionEnd="clickMe" ref="swiperTop">
                            <swiper-slide v-for="(item,index) in videoList" :key="index">
                                <div style="position:relative;">
                                    <video :src="item.addr" width="100%" height="100%" controls="controls"/>
                                </div>
                            </swiper-slide>
                        ...
                        <!--<swiper :options="swiperOption" ref="mySwiper">-->
                            <!--<swiper-slide v-for="(item,index) in videoList" :key="index">-->
                                <!--<div style="position:relative;">-->
                                    ...
                                    <!--&lt;!&ndash;<video :src="item.addr" width="100%"/>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<Icon type="play" class="video-play" @click.native="playVideo(item.addr)"></Icon>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<Icon type="ios-circle-outline" class="video-circle" @click.native="playVideo(item.addr)"></Icon>&ndash;&gt;-->
                                    <!--<p style="line-height: 26px;width: 900px;font-family: PingFangSC-Regular;padding-bottom: 70px;padding-top: 30px;color: #333333;font-size: 18px;text-indent: 2em;">{{item.describe}}</p>-->
                                <!--</div>-->
                            <!--</swiper-slide>-->
                        ...
                        <template v-if="AplayerShow && songs.length>0">
                            ...
                            <p style="line-height: 24px;padding-bottom: 10px;color: #666;font-size: 14px;text-indent: 2em;word-wrap:break-word">{{v.describe}}</p>
                    ...
                    <Row type="flex" align="middle">
                       ...
                       <collect-modal v-model="collectShow" v-on:collectForm="collectForm" :itemId="itemId" :itemType="itemType" :link="link" :collectTitle="collectTitle"/>
                        <Col span="4">
                            <div class="zanBtn">
                ...
                <div class="mb30">
                    <div class="comment-detail">
                        <div>
                            <h5 ><Icon type="chatbox-working"> </Icon></h5>
