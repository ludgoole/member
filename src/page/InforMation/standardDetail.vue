    ...
    <div class="searchModal">
        ...
        <div class="container">
            <Breadcrumb separator=">" class="mt20 mb10">
                ...
                <Breadcrumb-item href="/pro/standardList?flag=2">标准</Breadcrumb-item>
            ...
            <Row>
                <Col span="18">
                    ...
                    <div class="zx-time clear">
                        ...
                        <a :href="editerUrl"><span>发布人：{{ standard.author }}</span></a>
                    ...
                    <div style="border: solid 1px #DEDEDE;margin-top: 20px;">
                        <Row style="line-height: 60px;border-bottom: solid 1px #DEDEDE;">
                            ...
                            <Col span="12" style="text-align: right;">
                                <Button type="ghost" v-if="isTXT && standard.standardFile" @click="change" style="margin-right: 20px;">转为PDF阅读模式</Button>
                                <Button type="ghost" v-if="!isTXT && standard.standardText" @click="change" style="margin-right: 20px;">转为正文阅读模式</Button>
                            </Col>
                        </Row>
                        <Row>
                    ...
                    <Row type="flex" align="middle">
                        <Col span="10">
                            <h3 class="xgzx ell">
                                ...
                                <template v-else>
                                    <a :href="['/InforMation/standardDetail?id='+standard.previousMap.previousId+'&status='+status]"><span style="color: #4FAC77;">{{standard.previousMap.title}}</span></a>
                                </template>
                            </h3>
                            <h3 class="xgzx ell">
                                下一篇：
                                ...
                                <template v-else>
                                    <a :href="['/InforMation/standardDetail?id='+standard.nextMap.previousId+'&status='+status]"><span style="color: #4FAC77;">{{standard.nextMap.title}}</span></a>
                                </template>
                            </h3>
                        </Col>
                        ...
                        <Col span="2" push="8" style="text-align: right;">
                            <Button type="text" style="padding-right: 0px" @click="jubaoAdd"><Icon type="alert-circled" size="16"></Icon> 举报</Button>
                        </Col>
                    </Row>
                    <!-- 标准详情页评论 -->
                    <div class="mb30">
            ...
            then(response => {
                ...
                if (response.code === 200) {
                    ...
                    if (this.standard.account) {
                        api.get('/member/login/findbyname/' + this.standard.account).then(resp => {
                            if (200 === resp.code) {
