        ...
        <div class="layouts pt30 pb50">
            ...
            <div v-if="data.length > 0">
                <div class="com-dynamic-list">
                    <list @on-change="handleClick" bookType="knowledge" :data="data"></list>
                </div>
                <div class="tc mt30">
                    <Page class="expert-gate-page" :total="total" @on-change="handlePageChange"></Page>
                </div>
            </div>
...
.perDynamic .ivu-btn-ghost:hover {
    color: #ff7921;
    background-color: transparent;
    border-color: #ff7921;
}
.perDynamic .ivu-breadcrumb a:hover{color: #f5a623;}
