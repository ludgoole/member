<template>
    <div class="wrapper person-brief">
        ...
        <div class="layouts experttabs">
            <div class="tc mb20">
                <Avatar v-if="data.avatar !== ''" class="person-user" :src="data.avatar" />
...
export default {
    ...
    methods: {
        handleTabClick (e) {
            this.$router.push(`/expertGate/brief/${e}?uid=${this.$route.query.uid}`)
        },
        getData(){ 
...
.experttabs .ivu-tabs-nav .ivu-tabs-tab:hover{color: #1E7505;}
.experttabs .ivu-tabs-nav .ivu-tabs-tab-active{color: #1E7505;}
.experttabs .ivu-tabs-ink-bar-animated{background-color: #1E7505;}
</style>
