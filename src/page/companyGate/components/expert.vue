<template>
    <div class="pb50">
        <div v-if="data.length > 0">
                ...
                <Col span="6" v-for="(item,index) in data" :key="index" class="pb20">
                    ...
                    <a v-on:click="webimchat(item.userId, item.name, item.src)" >
                        ...
                        <div class="info pd20">
                            ...
                            <a :href="item.url" class="mt10"><Button type="ghost">更多信息 <Icon type="ios-arrow-right"></Icon></Button>
                                </a>
                        </div>
                    </Card>
                </Col>
            ...
            <div class="tc mt30">
                <Page :total="page.total" :current="page.current" @on-change="handlePageChange" :page-size="page.pageSize"  v-if="page.show"></Page>
            </div>
        </div>
