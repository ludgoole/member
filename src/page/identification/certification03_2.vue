				...
				<Col span="12" style="border: 1px solid #ededed;width: 358px;margin-right: 26px;">
                    <div style="margin-left: 128px;">
                        ...
                        <div style="margin: 14px">
                            <Button type="ghost" size="small" @click="handleFilterModal('speciFilter')">添加</Button>&nbsp;&nbsp;&nbsp;
				...
				<Col span="12" style="border: 1px solid #ededed;width: 358px">
                    <div style="text-align: center">
                        ...
                        <div class="zhuce-list2">
                            <template>
                                <Tag v-for="item in specResult" :key="item" type="border" :name="item" closable color="green" @on-close="handleClose">{{item}}</Tag>
                            </template>
                        </div>
                        <div style="margin: 14px">
