<template>
	...
	<div class="clear">
		...
		<div class="tr mr100 pb20">
			 <ButtonGroup>
				<Button type="ghost"  @click="checkAll">全选</Button>
				<Button type="ghost"  @click="checkChange">反选</Button>
			</ButtonGroup>
			<!-- <p style="font-size: 16px;color:#51ad79;margin-right:100px" class="fr  mt20 mb20" @click="checkAll()">全部选择</p> -->
		</div>
