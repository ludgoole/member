	...
	export default {
		data() {
			return {
				...
				templatePerson:[
					{
						src:'http://192.168.7.61/00/3E/wKgHPVpnJmWAVJnzAABF3huDu6A351.png',
						name:'个人模板',
						checked: false,
						type:0
					},
					{
						src:'http://192.168.7.61/00/3E/wKgHPVpnJl-AKnZNAABMck87kHE045.png',
						name:'企业模板',
						checked: false,
						type:1
					},
					{
						src:'http://192.168.7.61/00/40/wKgHPVpoQgyAYzi3AABN3nFWl1E198.png',
						name:'专家模板',
						checked: false,
						type:4
					},
					{
						src:'http://192.168.7.61/00/3E/wKgHPVpnJmKAXmLVAAA-ysLVAJM761.png',
						name:'机关模板',
						checked: false,
						type:3
					},
				...
				templateOrgans:[
					...
					{
						src:'http://192.168.7.61/00/3E/wKgHPVpnJluAXKyZAABEyzWmeHw811.png',
						name:'乡村模板',
						checked: false,
						type:5
					},
		...
		created() {
			...
			var account=JSON.parse(sessionStorage.getItem("user")).loginAccount
