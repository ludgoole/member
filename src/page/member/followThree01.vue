        ...
        <div style="padding: 0 38px">
            <Row class="follow-top">
                ...
                <div class="follow-add">
                    <Button type="ghost" @click="handleFilterModal('speciFilter')">添加</Button>
                    <Button type="ghost" @click="deleteType">删除</Button>
                </div>
                </Col>
                <Col span="12">
                <div class="follow-box">
                    ...
                    <div class="follow-tag">
                         <template>
                        <Tag v-for="(item,index) in specResult" :key="item" type="border"  :name="item"  closable color="green" @on-close="handleClose">{{item}}</Tag>
                         </template>
                    </div>
                </div>
