					                        ...
					                        render: (h, params) => {
					                            ...
					                            return h('div', [
					                                h('a', {
					                                    ...
					                                    style: {
					                                        marginRight: '5px',
					                                        color: params.row.mapSign === '已标示'?fontColor = '#51ad79':fontColor = '#333'
					                                    },
					                                    on: {
					                                        click: () => {
					                        ...
					                        render: (h, params) => {
					                            ...
					                            return h('div', [
					                                h('a', {
					                                    ...
					                                    style: {
					                                        marginRight: '5px',
					                                        color: params.row.soilInfo === '已上传'?fontColor = '#51ad79':fontColor = '#333'
					                                    },
					                                    on: {
					                                        click: () => {
					                        ...
					                        render: (h, params) => {
					                            ...
					                            return h('div', [
					                                h('a', {
					                                    ...
					                                    style: {
					                                        marginRight: '5px',
					                                        color: params.row.waterQualityInfo === '已上传'?fontColor = '#51ad79':fontColor = '#333'
					                                    },
					                                    on: {
					                                        click: () => {
