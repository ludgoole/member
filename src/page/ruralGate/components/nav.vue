        ...
        <div class="rural-gate-head">
            <div class="layouts pd10">
                ...
                <!--<Row  type="flex" align="middle">                    -->
                    ...
                    <!--</Col>-->
                    <!--<Col span="4">-->
                        <!--<p class="t-green h5" v-if="headData.mobile">-->
    ...
    data () {
        return {
            ...
            data:[{
                ...
                title: '乡村介绍',
                url: 'beautifulCountry',
                checked: false,
                isShow: true,
                child:[
                //     {
                //     name:'乡村视频',
                //     url:'countryIntroduction'
                // }
                {
                    name:'美丽乡村',
                    url:'beautifulCountry',
...
//                        console.log(response.data)
                        ...
                        this.data.map(function(item){
                            ...
                            if(item.title === '基地'){
                                item.isShow = false
                            }else if(item.title === '土特产'){
                                item.isShow = false
                            }else if(item.title === '种养户'){
                                item.isShow = false
                            }else if(item.title === '供需平台'){
                                item.isShow = false
                            }else if(item.title === '村务公开'){
                                item.isShow = false
                            }
                        })
                    }
...
.rural-gate-head{
    background: url(../../../img/rural-banner.png) center no-repeat;
}
.rural-gate-nav{
