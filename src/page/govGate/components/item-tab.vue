<template>
    <Row type="flex" align="bottom" class="gov-rural-item-tab gov-ivu-breadcrumb" :style="{'border-bottom': breadcrumb.length ? 'none' : '1px solid #ddd'}">
        <Col span="12">
