<template>
  <div class="pt30 pl10 pr10 family-deatil">
      <Form ref="edits" label-position="left" :label-width="150">
        ...
        <Card v-for="(item , index) in data" :key="index" class="mb20" :bordered="false" @click="getIndex(index)">
                    ...
                    <Row :gutter="16">
                        <Col span="8">
                            <Form-item  prop="name" label="成员名称">
                                <Input v-model="item.name" placeholder="请输入成员名称"></Input>
                            </Form-item>
                        </Col>
                        <Col span="8">
                            <Form-item prop="relationship" label="与户主关系">
                                <Input v-model="item.relationship"></Input>
                            </Form-item>
                        </Col>
                        <Col span="8">
                        ...
                        <Col span="8">
                            <Form-item prop="skill" label="劳动技能">
                                <Input v-model="item.skill"></Input>
                            </Form-item>
                        </Col>
                    </Row>
                </Form>
