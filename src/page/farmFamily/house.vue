                ...
                <Row :gutter="32">
                    ...
                    <Col span="12">
                        <Form-item prop="addr" label="房屋地址">
                            ...
                            <!-- <vui-cascander :values="addrs" @handle-get-result="format"></vui-cascander> -->
                            <!-- <Cascader :data="locationList" change-on-select v-model="item.addr" :render-format="formats" :load-data="loadPositionDatas"></Cascader> -->
                            <!-- <Cascader :data="locationList" change-on-select v-model="item.addr" :load-data="loadPositionDatas"></Cascader> -->
                        </Form-item>
                    </Col>
                    <Col span="12">
                        <Form-item prop="buildingArea" label="建筑面积">
                            <Input v-model="item.buildingArea"><span slot="append">平方米</span></Input>
                        </Form-item>
                    </Col>
                    <Col span="12">
                        <Form-item prop="useArea" label="土地使用面积">  
                            <Input v-model="item.useArea" ><span slot="append">平方米</span></Input>   
                        </Form-item>
                    </Col>
                </Row>
                <Row :gutter="32">
                ...
                <Row :gutter="32"  v-if="item.certificate == '是'">
                    <Col span="12">
                        <Form-item prop="houseNumber" label="房屋所有权证编号">  
                            <Input v-model="item.houseNumber"></Input>
                        </Form-item>
                    </Col>                    
                    <Col span="12">
                        <Form-item prop="landNumber" label="土地使用证编号">  
                            <Input v-model="item.landNumber" ></Input>   
                        </Form-item>
                    </Col>
                     <Col span="12">
                        <Form-item prop="estate" label="不动产权证编号">  
                            <Input v-model="item.estate"></Input>
                        </Form-item>
                    </Col>
                </Row>
                <Row :gutter="32">
                    ...
                    <Col span="12">
                        <Form-item prop="distance" label="房屋与乡村公路的距离">  
                            <Input v-model="item.distance" ><span slot="append">米</span></Input>   
                        </Form-item>
                    </Col>
                    <Col span="12">
                ...
                <Row :gutter="32">
                    <Col span="24">
                        <Form-item prop="development" label="房屋建设情况描述">  
                            <Input v-model="item.development"  type="textarea" :autosize="{minRows: 3,maxRows: 5}"></Input>   
                        </Form-item>
                    </Col>
                </Row>
                <Row :gutter="32">
