    ...
    <div class="education pt30 pl10 pr10">
        ...
        <Modal
                            ...
                            <Row>
                                <Col :span="20">
                                    <Form-item prop="school" label="学校名称">
                                        <Input v-model="educationForm.school.model"  @on-change="onChange"></Input>
                                    </Form-item>
                                </Col>
                            ...
                            <Row>
                                <Col :span="20">
                                    <Form-item prop="major" label="专业名称">
                                        <Input v-model="educationForm.major.model"  @on-change="onChange"></Input>
                                    </Form-item>
                                </Col>
                                <Col :span="4" class="switch">
                            ...
                            <Row>
                                <Col :span="20">
                                    <Form-item prop="graduationTime" label="入学/毕业时间">
                                        <DatePicker v-model="educationForm.graduationTime.model" @on-change="handleTimeChange" type="daterange" format="yyyy/MM/dd"  :options="options3" split-panels placeholder="请选择时间"></DatePicker>
                                    </Form-item>
                                </Col>
                                <Col :span="4" class="switch">
            ...
            <div slot="footer" class="tc">
                <Button type="ghost" @click="educationShow = false">取消</Button>
