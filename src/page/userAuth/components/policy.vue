            ...
            <Row :gutter="32">
                <Col span="12">
                    <Form-item label="政治面貌">
                        <Select v-model="data.policy.model" clearable style="width: 250px;">
                ...
                <Col span="12">
                    <Form-item label="加入时间">
                        <Date-picker v-model="data.joinTime.model" format="yyyy年MM月" :options="options" 
                            type="month" placeholder="选择日期" transfer style="width: 250px;">
                        </Date-picker>
    ...
    methods:{
        ...
        onchange(){
            ...
            if (newValue.joinTime.status && newValue.joinTime.model !== '') {
                this.content += this.moment(newValue.joinTime.model).format('YYYY年MM月')
            }
