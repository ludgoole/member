                            ...
                            <Row :gutter="32">
                                <Col :span="20">
                                    <Form-item prop="WorkUnit" label="工作单位">
                                        <Input v-model="formItem.WorkUnit.model" @on-change="onChange" ></Input>
                                    </Form-item>
                                </Col>
                                <Col :span="4">
                            ...
                            <Row :gutter="32">
                                <Col :span="20">
                                    <Form-item prop="job" label="工作职位">
                                        <Input v-model="formItem.job.model" @on-change="onChange" ></Input>
                                    </Form-item>
                                </Col>
                                <Col :span="4">
                            ...
                            <Row :gutter="32">
                                <Col :span="20">
                                    <Form-item prop="workTime" label="工作时间">
                                        <DatePicker v-model="formItem.workTime.model" type="daterange" @on-change="handleTimeChange" format="yyyy/MM/dd"  :options="options3" style="width:100%" split-panels placeholder="请选择时间"></DatePicker>
                                    </Form-item>
                                </Col>
                                <Col :span="4">
            ...
            for(var key  in formItem){
                if(formItem[key] && formItem[key].model && formItem[key].status){
                    if(formItem[key].name == '工作时间'){
                        console.log(formItem[key].model)
