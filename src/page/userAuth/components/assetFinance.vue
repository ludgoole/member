  ...
  <div  class="pt30 pl10 pr10 asset-finance"> 
    ...
    <Modal
        ...
        <div slot="footer" class="tc">
            <Button type="ghost" @click="bankCredit = false">取消</Button>
     ...
     <Modal
        ...
        <div slot="footer" class="tc">
            <Button type="ghost" @click="assets = false">取消</Button>
     ...
     <Modal
        ...
        <div slot="footer" class="tc">
            <Button type="ghost" @click="bankAccount = false">取消</Button>
...
import {isNumber,isBankCard} from '~utils/validate'
    export default{
        components:{
            displayCard
        },
