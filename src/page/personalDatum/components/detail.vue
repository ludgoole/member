...
<div>
    ...
    <Card class="company-auth-5" >
        ...
        <div id="privateInformation" v-if="tabsList.privateInformation">
            <Title title="隐私信息">
                <Button type="primary" size="small" @click="handleModify('privateInformation')" v-if="isedit" >修改</Button>
            </Title>
            <private-information ref="privateInformation" ></private-information>
        </div>
        <div id="networkInformation" v-if="tabsList.networkInformation">
            <Title title="网络信息">
                <Button type="primary" size="small" @click="handleModify('networkInformation')" v-if="isedit" >修改</Button>
            </Title>
            <network-information ref="networkInformation" ></network-information>
        </div>
        <div id="education" v-if="tabsList.education">
            <Title title="教育经历">
                <Button type="primary" size="small" @click="handleModify('education')" v-if="isedit" >修改</Button>
            </Title>
            <education ref="education" ></education>
        </div>
        <div id="work" v-if="tabsList.work">
            <Title title="工作经历">
                <Button type="primary" size="small" @click="handleModify('work')" v-if="isedit" >修改</Button>
            </Title>
            <work ref="work" ></work>
        </div>
        <div id="policy" v-if="tabsList.policy">
            <Title title="政治面貌">
                <Button type="primary" size="small" @click="handleModify('policy')" v-if="isedit" >修改</Button>
            </Title>
            <policyInfo ref="policy" ></policyInfo>
        </div>
        <div id="religion" v-if="tabsList.religion">
            <Title title="宗教信仰">
                <Button type="primary" size="small" @click="handleModify('religion')" v-if="isedit" >修改</Button>
            </Title>
            <religionInfo ref="religion" ></religionInfo>
        </div>
        <div id="professionalInformation" v-if="tabsList.professionalInformation">
            <Title title="专业信息">
                <Button type="primary" size="small" @click="handleModify('professionalInformation')" v-if="isedit" >修改</Button>
            </Title>
            <professional-information ref="professionalInformation" ></professional-information>
        </div>
        <div id="corpHonor" v-if="tabsList.corpHonor">
            <Title title="荣誉风采">
                <Button type="primary" size="small" @click="handleModify('corpHonor')" v-if="isedit" >修改</Button>
            </Title>
            <corp-honor ref="corpHonor" ></corp-honor>
        </div>
        <div id="house"  v-if="tabsList.house">
            <Title title="房屋生活情况">
                <Button type="primary" size="small" @click="handleModify('house')" v-if="isedit" >修改</Button>
            </Title>
            <house ref="house" ></house>
        </div>
        <div id="modern" v-if="tabsList.modern">
            <Title title="家庭现代化情况">
                <Button type="primary" size="small" @click="handleModify('modern')" v-if="isedit" >修改</Button>
            </Title>
            <modern ref="modern" :isAdd="false" ></modern>
        </div>
        <div id="department" v-if="tabsList.department">
            <Title title="组织机构">
                <Button type="primary" size="small" @click="handleModify('department')" v-if="isedit" >修改</Button>
            </Title>
            <department ref="department"></department>
        </div>
        <div id="team" v-if="tabsList.team">
            <Title title="管理团队">
                <Button type="primary" size="small" @click="handleModify('team')" v-if="isedit" >修改</Button>
            </Title>
            <team ref="team" ></team>
        </div>
        <div id="survey" v-if="tabsList.survey">
            <Title title="经营概况">
                <Button type="primary" size="small" @click="handleModify('survey')" v-if="isedit" >修改</Button>
            </Title>
            <survey ref="survey" ></survey>
        </div>
        <div id="assetFinance"  v-if="tabsList.assetFinance">
            <Title title="财务信息">
                <Button type="primary" size="small" @click="handleModify('assetFinance')" v-if="isedit" >修改</Button>
            </Title>
            <asset-finance ref="assetFinance" ></asset-finance>
        </div>
        <div id="productService" v-if="tabsList.productService">
            <Title title="产品&服务">
                <Button type="primary" size="small" @click="handleModify('productService')" v-if="isedit" >修改</Button>
            </Title>
            <product-service ref="productService" ></product-service>
        </div>
        <div id="qualification" v-if="tabsList.qualification">
            <Title title="专业资质">
                <Button type="primary" size="small" @click="handleModify('qualification')" v-if="isedit" >修改</Button>
            </Title>
            <qualification ref="qualification" ></qualification>
        </div>
        <div id="commonAssets"  v-if="tabsList.commonAssets">
            <Title title="普通资产">
                <Button type="primary" size="small" @click="handleModify('commonAssets')" v-if="isedit" >修改</Button>
            </Title>
            <common-assets ref="commonAssets"></common-assets>
        </div>
        <div id="intangibleAssets"  v-if="tabsList.intangibleAssets">
            <Title title="无形资产">
                <Button type="primary" size="small" @click="handleModify('intangibleAssets')" v-if="isedit" >修改</Button>
            </Title>
            <intangible-assets ref="intangibleAssets" ></intangible-assets>
        </div>
        <div id="facilityAssets"  v-if="tabsList.facilityAssets">
            <Title title="设施资产">
                <Button type="primary" size="small" @click="handleModify('facilityAssets')" v-if="isedit" >修改</Button>
            </Title>
            <facility-assets ref="facilityAssets"></facility-assets>
        </div>
        <div id="placeOfBusiness"  v-if="tabsList.placeOfBusiness">
            <Title title="经营场所">
                <Button type="primary" size="small" @click="handleModify('placeOfBusiness')" v-if="isedit" >修改</Button>
            </Title>
...
<script>
    ...
    export default{
		...
		created() {
            ...
            if(this.loginUser.loginAccount == this.account){
                this.isedit = true
