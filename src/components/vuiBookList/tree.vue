  ...
  <div style="max-height:280px; overflow-y:auto" class="scroll">
    ...
    <li>
      <div class="vui-flex vui-flex-middle pl5 pr5 item" :class="{active: d.checked}">
        <Icon type="arrow-right-b" :class="{active: d.expand}" class="vui-book-arrow" @click.native="handleToggle(d, i)"></Icon>
              ...
              <div class="vui-flex vui-flex-middle">
                ...
                <div>
                  <span class="oper-btn-wrap">
                    <Icon type="plus" size="14" @click.native.stop="handleAdd(d, i)"></Icon>
                  </span>
                  <Poptip
                    confirm
                    title="您确认删除吗？"
