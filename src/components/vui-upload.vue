<template>
  <div class="vui-upload-component">
    <Upload ref="upload" :show-upload-list="false"
      ...
      <!-- <div class="upload-add-div photo-selector" v-else>
        <Icon type="plus-circled" color="#51ad79" size="32"></Icon>
        <p class="mb5">上传图片</p>
        <p class="t-grey">支持{{this.format}}格式</p>
        <p class="t-grey">不超过{{this.size}}M</p>
      </div> -->
    </Upload>
    <Button type="ghost"  @click="handlePhotoSelectorModal('photo')"><Icon type="ios-download-outline" size="16" class="pr5"></Icon> 从文件管理导入</Button>
    <!-- <div class="upload-add-div photo-selector" v-else @click="handlePhotoSelectorModal('photo')">
      <Icon type="plus-circled" color="#51ad79" size="32"></Icon>
...
export default {
  ...
  created(){
    this.maxsize = parseInt(this.size) *1024
