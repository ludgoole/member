...
<script>
    ...
    export default {
        ...
        data() {
            return {
                user: '',
                url: '//192.168.7.42:8081',
                socketUrl: '//192.168.7.42:30000',
                // url: '//192.168.100.205:8081',
                // socketUrl: '//192.168.100.205:30000',
                layim: null,
                // websocket: null,
            };
        },
        ...
        methods: {
            showUnreadMsgCount() {
                ...
                axios.get(`${this.url}/groupfriend/getUnreadMsgCount/${this.user}`).then((res,status) => {
                    layim.msgbox(res);
                });
            },
            layIm() {
                ...
                layui.use(['layim', 'layer', 'customRightClick', 'jquery'], (layim, layer, customRightClick, $) => {
                    ...
                    //var webSocketUrl = `ws:${this.url}/websocket/${this.user}`;
                    ...
                    websocket.onmessage = (event) => {
                        ...
                        if (resEmit == "onlineRes") {
                            ...
                            layim.config({
                                ...
                                uploadImage: {
                                    url: `${this.url}/im/upload/img`
                                    //+ layim.cache().mine.id
                                },
                                uploadFile: {
                                    url: `${this.url}/im/upload/file`
                                },
                            //members 获取群员列表
                                /*members: {
